...
/** 
    ...
    ****Note - for PTC we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
static const unsigned int SPTCDARD_LOCKTIME_VERIFY_FLAGS = LOCKTIME_VERIFY_SEQUENCE |
...
public:
    ...
    /** 
     * Amount of purpleturtle coming in to a transaction
