...
/** Utility functions used by the PTC Qt UI.
 */
namespace GUIUtil
{
...
// Render PTC addresses in monospace font
...
// Parse "purpleturtle:" URI into recipient object, return true on successful parsing
