                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PurpleTurtle-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PurpleTurtle address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and purpleturtle: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PurpleTurtle Core"), this);
    aboutAction->setStatusTip(tr("Show information about PurpleTurtle Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PurpleTurtle"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PurpleTurtle addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PurpleTurtle addresses"));
    ...
    openAction->setStatusTip(tr("Open a PurpleTurtle: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PurpleTurtle Core help message to get a list with possible PurpleTurtle command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PurpleTurtle Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PurpleTurtle network", "", count));
}
...
{
    QString strTitle = tr("PurpleTurtle Core"); // default title
