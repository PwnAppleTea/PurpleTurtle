...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PurpleTurtle Core purpleturtle-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  purpleturtle-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded purpleturtle transaction") + "\n" +
                               "  purpleturtle-tx [options] -create [commands]   " + _("Create hex-encoded purpleturtle transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded purpleturtle transaction
