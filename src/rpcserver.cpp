...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop PurpleTurtle server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "PurpleTurtle server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PTC features */
        {"purpleturtle", "masternode", &masternode, true, true, false},
        {"purpleturtle", "masternodelist", &masternodelist, true, true, false},
        {"purpleturtle", "mnbudget", &mnbudget, true, true, false},
        {"purpleturtle", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"purpleturtle", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"purpleturtle", "mnsync", &mnsync, true, true, false},
        {"purpleturtle", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"purpleturtle", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use taurusnetworkd, or the -server option to purpleturtle-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"PurpleTurtle Alert\" admin@foo.com\n"),
...
{
    return "> purpleturtle-cli " + methodname + " " + args + "\n";
}
