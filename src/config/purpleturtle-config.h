/* src/config/purpleturtle-config.h.  Generated from purpleturtle-config.h.in by configure.  */
/* src/config/purpleturtle-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://purpleturtle.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PurpleTurtle Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PurpleTurtle Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "purpleturtle"
