...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_2_INSPTCTX) r = SPORK_2_INSPTCTX_DEFAULT;
        if (nSporkID == SPORK_3_INSPTCTX_BLOCK_FILTERING) r = SPORK_3_INSPTCTX_BLOCK_FILTERING_DEFAULT;
...
{
    if (strName == "SPORK_2_INSPTCTX") return SPORK_2_INSPTCTX;
    if (strName == "SPORK_3_INSPTCTX_BLOCK_FILTERING") return SPORK_3_INSPTCTX_BLOCK_FILTERING;
...
{
    if (id == SPORK_2_INSPTCTX) return "SPORK_2_INSPTCTX";
    if (id == SPORK_3_INSPTCTX_BLOCK_FILTERING) return "SPORK_3_INSPTCTX_BLOCK_FILTERING";
